...
<%@ page import="spockintegration.Account" %>
<html>
    <head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: accountInstance, field: 'transactions', 'errors')}">
                                    <g:select name="transactions" from="${spockintegration.Transaction.list()}" multiple="yes" optionKey="id" size="5" value="${accountInstance?.transactions*.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: accountInstance, field: 'user', 'errors')}">
                                    <g:select name="user.id" from="${spockintegration.User.list()}" optionKey="id" value="${accountInstance?.user?.id}"  />
                                </td>
                            </tr>

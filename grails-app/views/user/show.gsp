<%@ page import="spockintegration.User" %>
<html>
<head>
...
<div class="body">
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="user.account.label" default="Account"/></td>

                <td valign="top" class="value"><g:link controller="account" action="show" id="${userInstance.id}">${fieldValue(bean: userInstance, field: "account")}</g:link></td>
